...
while route_cntr<len(route_raw) and not rospy.is_shutdown():
  ...
  sget=get_state("turtlebot3_burger","world")
  ...
  if loop_cntr%20==0 and PERTURBATIONS_SIZE>0:
    ...
    wret=apply_wrench(body_name="turtlebot3_burger",wrench=wrench,duration=rospy.Duration(1.0/100))
